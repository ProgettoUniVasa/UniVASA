...
public class Utente {
    ...
    public Utente(Long id, String nome, String cognome, String email, String username, String password, String telefono,
			LocalDate data_nascita, Enum professione, String nome_università, String dipartimento) {
		super();
		this.id = id;
		this.nome = nome;
	...
	public void setProfessione(Enum professione) {
		this.professione = professione;
	}
